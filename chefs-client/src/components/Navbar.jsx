...
const Navbar = () => {
  ...
  return (
    <header
      className={`max-w-screen-2x container mx-auto fixed top-0 left-0 right-0 transition-all duration-300 ease-in-out`}
    >
      <div
        ...
        <div className="navbar-end ">
          ...
          {user ? (
            ...
            <button
              ...
              className="btn flex items-center gap-2 rounded-full px-6 bg-black hover:bg-white hover:text-black text-white"
            >
              <FaRegUser /> Login
            </button>
          )}
